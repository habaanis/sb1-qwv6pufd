    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div
              className="absolute inset-0 scale-125 translate-x-10 translate-y-10 bg-[url('/images/drapeau-tunisie.jpg')] bg-no-repeat bg-center opacity-100 mix-blend-soft-light pointer-events-none"
