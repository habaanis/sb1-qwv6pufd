/*
  # Ajout de l'ID et du slug dans l'autocomplete

  1. Objectif
    - Ajouter l'ID de l'entreprise pour les suggestions de type 'entreprise'
    - Permettre la navigation directe vers la fiche entreprise

  2. Changements
    - Ajout de la colonne 'id' dans le retour
    - Utilisation de l'ID pour créer le slug
*/
