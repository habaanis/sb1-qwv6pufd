      ...
      <section className="py-6 px-4 relative z-50">
        <div className="max-w-5xl mx-auto">
          <CategorySearchBar
            ...
            onSelectBusiness={(businessId) => window.location.hash = `#/business/${businessId}`}
                  ...
                  {shops.map((shop) => (
                      <div
                        ...
                        onClick={async () => {
                          ...
                          console.log('🛒 CLIC SHOP - ID:', shop.id, 'Nom:', shop.nom);

                          // Charger toutes les données du magasin
